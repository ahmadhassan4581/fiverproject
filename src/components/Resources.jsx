...
const Resources = () => {
  ...
  return (
    <section id="resources" className="py-20 lg:py-28 bg-[#0a0a0a]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {resources.map((resource) => {
            ...
            return (
              <div
                key={resource.id}
                className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-6 card-3d group cursor-pointer hover:border-[#c6a43f]/50 transition-all"
              >
                <div className="p-3 bg-[#2a2a2a] rounded-lg w-fit mb-4 transition-all duration-300 group-hover:bg-[#c6a43f]/20 group-hover:scale-110">
                ...
                <p className="text-sm text-[#a3a3a3] mb-4 line-clamp-3">{resource.description}</p>
                <div className="flex items-center justify-between mt-auto">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-sm font-medium text-[#c6a43f] hover:text-[#d4b75a] transition-colors duration-300"
                  >
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
          <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto animate-scaleIn">
            <div className="flex items-center justify-between p-6 border-b border-[#2a2a2a]">
              <div className="flex items-center gap-3">
                {selectedResource && (
                  <>
                    <div className="p-2 bg-[#2a2a2a] rounded-lg">
                      <selectedResource.icon className="w-5 h-5 text-[#c6a43f]" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-white text-sm">Download Resource</h3>
                      <p className="text-xs text-[#737373] truncate max-w-[200px]">{selectedResource.title}</p>
                    </div>
                  </>
                )}
              </div>
              <button
                onClick={closeModal}
                className="p-2 text-[#737373] hover:text-white hover:bg-[#2a2a2a] rounded-lg transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-6">
              {!isSubmitted ? (
                <>
                  <div className="flex items-center gap-2 mb-4 text-[#c6a43f]">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-2 bg-[#111111] border rounded-lg focus:ring-2 focus:ring-[#c6a43f] focus:border-[#c6a43f] outline-none transition-all text-white ${
                            formErrors.fullName ? 'border-red-500' : 'border-[#2a2a2a]'
                          }`}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-[#a3a3a3] mb-1">
                        Business Email <span className="text-[#c6a43f]">*</span>
                      </label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-2 bg-[#111111] border rounded-lg focus:ring-2 focus:ring-[#c6a43f] focus:border-[#c6a43f] outline-none transition-all text-white ${
                            formErrors.email ? 'border-red-500' : 'border-[#2a2a2a]'
                          }`}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <Building2 className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#737373]" />
                        <input
                          type="text"
                          required
                          ...
                          className={`w-full pl-10 pr-4 py-2 bg-[#111111] border rounded-lg focus:ring-2 focus:ring-[#c6a43f] focus:border-[#c6a43f] outline-none transition-all text-white ${
                            formErrors.company ? 'border-red-500' : 'border-[#2a2a2a]'
                          }`}
                    ...
                    <div className="pt-4">
                      <button
                        type="submit"
                        className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-medium text-[#0a0a0a] bg-[#c6a43f] hover:bg-[#d4b75a] rounded-lg transition-all"
                      >
                        <Download className="w-4 h-4" />
                        Download Resource
                      </button>
                ...
                <div className="text-center py-8">
                  <div className="w-16 h-16 bg-[#c6a43f]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Check className="w-8 h-8 text-[#c6a43f]" />
                  </div>
                  ...
                  <button
                    onClick={closeModal}
                    className="mt-6 px-6 py-2 text-sm font-medium text-[#c6a43f] bg-[#c6a43f]/10 hover:bg-[#c6a43f]/20 border border-[#c6a43f]/30 rounded-lg transition-colors"
                  >
                    Close
                  </button>
                </div>
